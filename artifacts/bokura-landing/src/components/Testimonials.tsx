  ...
  return (
    <section id="testimonials" className="py-16 sm:py-24 relative z-10">
      <div className="container mx-auto px-5 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block text-xs sm:text-sm font-semibold text-primary uppercase tracking-widest mb-3">{t.testimonials.label}</span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-white mb-4">
            {t.testimonials.title} <span className="text-gradient-cyan">{t.testimonials.titleGradient}</span>
          </h2>
        </motion.div>
